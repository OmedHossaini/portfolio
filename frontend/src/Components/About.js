    ...
    <section className="about section" id="about">
      ...
      <div className="about__container bd-grid">
        ...
        <div>
          ...
          <p className="about__text">I am a passionate full-stack web developer, dedicated to crafting beautiful and functional web applications. My skill set includes<strong> HTML, CSS, JavaScript, Node.js,</strong> and <strong>React</strong></p>
<br></br>
